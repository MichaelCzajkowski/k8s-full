...
{{/*
Create the name of log level value
*/}}
{{- define "python-api.logLevel" -}}
{{- if .Values.logLevel.create }}
{{- default (include "python-api.logLevel" .) .Values.logLevel.name }}
{{- else }}
{{- default "default" .Values.logLevel.name }}
{{- end }}
{{- end }}